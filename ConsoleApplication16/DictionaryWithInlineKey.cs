...
{
    // Type: System.Collections.Generic.DictionaryWithInlineKey`2
    ...
    public class DictionaryWithInlineKey<TKey, TValue> : IDictionary<TKey, TValue>, ICollection, IReadOnlyDictionary<TKey, TValue>
    {
        ...
        /// <summary>
        ///     Gets a collection containing the keys in the <see cref="T:System.Collections.Generic.DictionaryWithInlineKey`2" />.
        /// </summary>
        /// <returns>
        ///     A <see cref="T:System.Collections.Generic.DictionaryWithInlineKey`2.KeyCollection" /> containing the keys in the
        ...
        /// </summary>
        /// <param name="capacity">
        ///     The initial number of elements that the <see cref="T:System.Collections.Generic.DictionaryWithInlineKey`2" />
        ///     can contain.
        /// </param>
        ...
        /// </param>
        [TargetedPatchingOptOut("Performance critical to inline this type of method across NGen image boundaries")]
        public DictionaryWithInlineKey(IEqualityComparer<TKey> comparer)
            : this(0, comparer)
        {
        }
        ...
        /// </param>
        /// <exception cref="T:System.ArgumentOutOfRangeException"><paramref name="capacity" /> is less than 0.</exception>
        public DictionaryWithInlineKey(int capacity, IEqualityComparer<TKey> comparer)
        {
            if (capacity < 0)
        ...
        ///     new <see cref="T:System.Collections.Generic.DictionaryWithInlineKey`2" />.
        /// </param>
        ...
        /// <exception cref="T:System.ArgumentNullException"><paramref name="dictionary" /> is null.</exception>
        /// <exception cref="T:System.ArgumentException"><paramref name="dictionary" /> contains one or more duplicate keys.</exception>
        public DictionaryWithInlineKey(IDictionary<TKey, TValue> dictionary, IEqualityComparer<TKey> comparer)
        ...
        /// <summary>
        ///     Removes all keys and values from the <see cref="T:System.Collections.Generic.DictionaryWithInlineKey`2" />.
        /// </summary>
        public void Clear()
        {
            if (count <= 0)
        ...
        /// </returns>
        /// <param name="value">
        ///     The value to locate in the <see cref="T:System.Collections.Generic.DictionaryWithInlineKey`2" />. The value can
        ...
        ///     <paramref name="key" /> is not found in the <see cref="T:System.Collections.Generic.DictionaryWithInlineKey`2" />.
        /// </returns>
        ...
        /// <summary>
        ///     Enumerates the elements of a <see cref="T:System.Collections.Generic.DictionaryWithInlineKey`2" />.
        /// </summary>
        [Serializable]
        ...
        public sealed class KeyCollection : ICollection<TKey>, IEnumerable<TKey>, ICollection, IEnumerable
        {
            ...
            /// </summary>
            /// <param name="dictionary">
            ///     The <see cref="T:System.Collections.Generic.DictionaryWithInlineKey`2" /> whose keys are reflected in the
            ///     new <see cref="T:System.Collections.Generic.DictionaryWithInlineKey`2.KeyCollection" />.
            /// </param>
            /// <exception cref="T:System.ArgumentNullException"><paramref name="dictionary" /> is null.</exception>
            public KeyCollection(DictionaryWithInlineKey<TKey, TValue> dictionary)
            {
                if (dictionary == null)
                    throw new ArgumentNullException("dictionary");
                this.dictionary = dictionary;
            ...
            /// </summary>
            /// <returns>
            ///     A <see cref="T:System.Collections.Generic.DictionaryWithInlineKey`2.KeyCollection.Enumerator" /> for the
            ///     <see cref="T:System.Collections.Generic.DictionaryWithInlineKey`2.KeyCollection" />.
            /// </returns>
            public Enumerator GetEnumerator()
            {
            ...
            /// <summary>
            ///     Enumerates the elements of a <see cref="T:System.Collections.Generic.DictionaryWithInlineKey`2.KeyCollection" />.
            /// </summary>
            [Serializable]
            public struct Enumerator : IEnumerator<TKey>, IDisposable, IEnumerator
            {
                ...
                ///     <see cref="T:System.Collections.Generic.DictionaryWithInlineKey`2.KeyCollection.Enumerator" />.
                /// </summary>
                public void Dispose()
                {
                }
        ...
        public sealed class ValueCollection : ICollection<TValue>, IEnumerable<TValue>, ICollection, IEnumerable
        {
            ...
            /// </summary>
            /// <param name="dictionary">
            ///     The <see cref="T:System.Collections.Generic.DictionaryWithInlineKey`2" /> whose values are reflected in the
            ///     new <see cref="T:System.Collections.Generic.DictionaryWithInlineKey`2.ValueCollection" />.
            /// </param>
            /// <exception cref="T:System.ArgumentNullException"><paramref name="dictionary" /> is null.</exception>
            public ValueCollection(DictionaryWithInlineKey<TKey, TValue> dictionary)
            {
                if (dictionary == null)
                    throw new ArgumentNullException("dictionary");
                this.dictionary = dictionary;
            ...
            /// </summary>
            /// <returns>
            ///     A <see cref="T:System.Collections.Generic.DictionaryWithInlineKey`2.ValueCollection.Enumerator" /> for the
            ///     <see cref="T:System.Collections.Generic.DictionaryWithInlineKey`2.ValueCollection" />.
            /// </returns>
            public Enumerator GetEnumerator()
            {
            ...
            /// <summary>
            ///     Enumerates the elements of a <see cref="T:System.Collections.Generic.DictionaryWithInlineKey`2.ValueCollection" />.
            /// </summary>
            [Serializable]
            public struct Enumerator : IEnumerator<TValue>, IDisposable, IEnumerator
            {
                ...
                /// <summary>
                ///     Releases all resources used by the
                ///     <see cref="T:System.Collections.Generic.DictionaryWithInlineKey`2.ValueCollection.Enumerator" />.
                /// </summary>
                public void Dispose()
                {
                }
